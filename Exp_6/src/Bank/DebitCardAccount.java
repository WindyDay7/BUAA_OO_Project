...
public class DebitCardAccount extends Account {
	...
	public void setRate(double interestRate){
  	...
  	// 请补全repOK()方法	
  		if(this.annualInterestRate<0) return false;
  		if(this.getRate()<0) return false;
  		if(super.getAccountId()==null || super.getName()==null || super.getUserId()==null || super.getPwd()==null)
  			return false;
  		return true;
  	}
